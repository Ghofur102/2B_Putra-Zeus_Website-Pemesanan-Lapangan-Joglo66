...
@section('content')
    ...
    <p style="font-size: 15px; color: #475569;">Terima kasih telah mendaftar di <strong>Joglo66 Mini Soccer</strong>! Tinggal satu langkah lagi untuk menyelesaikan pendaftaran. Silakan klik tombol di bawah ini untuk memverifikasi alamat email Anda:</p>
    ...
    <div style="background-color: #fffbeb; border-left: 4px solid #f59e0b; padding: 15px; margin-top: 30px; border-radius: 4px;">
        <p style="margin: 0; color: #92400e; font-size: 13px;">
            <strong>CATATAN:</strong> Tautan verifikasi ini akan kedaluwarsa pada <strong>{{ $expiresAt }}</strong> (24 Jam). Jika sudah kedaluwarsa, Anda perlu mendaftar ulang.
        </p>
    </div>
