...
<head>
    ...
    <title>Pemesanan Lapangan - Booking Lapangan Olahraga</title>
    <style>
        :root {
        ...
        * {
        ...
        /* Layout: 3 columns or responsive */
        .main-layout {
            display: grid;
        ...
        .form-textarea:focus {
            outline: none;
            border-color: var(--color-primary);
            box-shadow: 0 0 0 2px rgba(58, 90, 140, 0.1);
        }
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="navbar-center">Pemesanan Lapangan</div>
    ...
    <div class="container">
        ...
        <div class="form-container">
            <div class="summary-section">
                <div class="summary-title">Ringkasan Pilihan Anda</div>
                <div class="summary-items">
                    <div class="summary-item">
                        <div class="summary-label">Slot Dipilih:</div>
            ...
            <form action="{{ route('tenant.booking.confirm-form') }}" method="POST" id="bookingForm">
                ...
                <!-- Hidden inputs -->
                <input type="hidden" id="formFieldId" name="field_id" value="{{ $field->id }}">
    ...
    <script>
        ...
        function renderSlotJam() {
            ...
            allSlots.forEach((slot, index) => {
                ...
                // Display full time range: "11:00 - 12:00"
                pill.textContent = `${slot.jam} - ${slot.jam_akhir}`;
        ...
        function updateSelectedInfo() {
            ...
            if (selectedDate && selectedSlots.length > 0) {
                ...
                // Display full time ranges: "11:00 - 12:00, 09:00 - 10:00"
                const slotTimes = selectedSlots.map(idx => {
                    const slot = allSlots[idx];
                    return `${slot.jam} - ${slot.jam_akhir}`;
                }).join(', ');
